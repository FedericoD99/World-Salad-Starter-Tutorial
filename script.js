...
//text (don't delete)!
let myStory = 
 `<p>One day, a ${objAdj1} ${objNoun1} named ${storyName1} decided to go on an adventure. ${storyName2} had always dreamed of finding the legendary ${objNoun2} hidden deep in the ${objPlace}.
